...
public class Main {
    ...
    private static void imprimirTabelaMedia(HashMap<String, HashMap<String, List<Double>>> resultados,
            String[] metricas) {
        System.out.println("===================================================");
    ...
    public static double calcularDistancia(double[] a, double[] b, int escolha) {
        ...
        switch (escolha) {
            ...
            default:
                throw new IllegalArgumentException("Índice de métrica inválido! Use 0 a 3.");
        }
    }
}
